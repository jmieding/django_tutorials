...
<p>
    ...
    You (or someone pretending to be you) asked to register an account at
    {{ site_name }}.  If this wasn't you, please ignore this email.
    Your email address will be automatically removed from our records.
    {% endblocktrans %}
</p>
<p>
    {% blocktrans %}
    To activate your user account, use the following link in the next
